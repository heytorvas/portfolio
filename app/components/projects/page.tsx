...
const projects: {
...
}[] = [
  {
    ...
    description: 'A tool for brazilian workers to help them with better understanding about your salary.',
  ...
  },
  {
    ...
    description:
      'A platform for developers to present their resume.',
...
const Projects = () => {
  ...
  return (
    <section className="pb-14 border-b border-slate-300 mb-14">
      ...
      <div
        className="lg:w-[170%] lg:-ml-[35%] grid grid-cols-1 md:grid-cols-2 grid-flow-dense gap-8 mt-16">
        {projects.map((project) => {
          ...
          return (
            ...
            >
              ...
              <h3
                className="text-slate-700 font-semibold tracking-tight text-xl">
                {project.title}
              </h3>
