...
export const metadata: Metadata = {
  ...
  description:
    'Heytor Victor is a python software engineer.',
  openGraph: {
    title: 'Heytor Victor - Software Engineer',
    images: [
      {
...
export default function RootLayout({
  ...
  return (
    ...
    <div className="max-w-2xl lg:max-w-xl mx-auto">
      ...
      {children}
      <footer
        className="px-4 md:px-0 border-t border-slate-200 py-8 text-slate-700 font-mono text-xs tracking-tight flex justify-between">
        <p>
